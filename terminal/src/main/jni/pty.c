...
Java_com_omnimaster_terminal_Pty_00024Companion_createSubprocess(JNIEnv *env, jobject thiz,
...
Java_com_omnimaster_terminal_Pty_00024Companion_waitFor(JNIEnv *env, jobject thiz, jint pid) {
    int status;
...
JNIEXPORT jint JNICALL
Java_com_omnimaster_terminal_Pty_00024Companion_getTerminalFlags(JNIEnv *env, jobject thiz, jint fd) {
    struct termios tt;
...
JNIEXPORT jint JNICALL
Java_com_omnimaster_terminal_Pty_00024Companion_getAvailableBytes(JNIEnv *env, jobject thiz, jint fd) {
    int available = 0;
...
JNIEXPORT jint JNICALL
Java_com_omnimaster_terminal_Pty_setPtyWindowSize(JNIEnv *env, jobject thiz, jint fd, jint rows, jint cols) {
    struct winsize ws;
    ws.ws_row = rows;
    ws.ws_col = cols;
    ws.ws_xpixel = 0;
